...
aoc_01_test_part1(Out):-
	solve_aoc_01_part1("test_data/data_01_2025.txt", Out).
...
solve_aoc_01_part1(FileName, Out):-
	...
	phrase(rotator(50, EndPoints, _ZeroPasses),
		Codes),
	msort(EndPoints, EP),
...
rotator(Start, [Finish|Finishes], ZeroPasses)-->
	"L",
	digits(NumberCodes),
	eol,
	{
...
solve_aoc_01_part2(FileName, ZeroPasses):-
	read_file_to_codes(FileName, Codes, []),
	phrase(rotator(50, _EndPoints, ZeroPasses),
		Codes).
